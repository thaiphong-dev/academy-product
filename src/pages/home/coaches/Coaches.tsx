...
const Coaches = () => {
  ...
  return (
    <>
      {/* ui for PC  */}
      <div className="w-full h-full flex-col justify-center items-center md:flex hidden">
        <div className="w-[1200px] h-full space-y-[20px] pb-[50px]">
          ...
          <div className="space-y-[20px]">
            ...
            <p>
              ...
              wealth of expertise, strategies, and insights to the table,
              creating a dynamic learning environment that fosters growth and
              excellence.
            </p>
            <p>
      ...
      <div className="w-full h-full flex flex-col justify-center items-center md:hidden">
        <div className="w-full px-[20px] h-full space-y-[20px] pb-[50px]">
          <div className="flex justify-center items-center py-[50px] w-full">
            <p className="text-[35px] font-bold uppercase text-main">
              our coaches
            </p>
          ...
          >
            {mockCoaches?.map((x) => (
              <SwiperSlide className="!m-0 !p-0 w-full" key={x?.name}>
                <MemberCard {...x} />
              </SwiperSlide>
            ))}
          </Swiper>
